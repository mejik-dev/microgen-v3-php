...
use Microgen\AuthClient;
use Microgen\QueryClient;
use Microgen\StorageClient;

class MicrogenClient
{
  public $auth;
  public $storage;
  ...
  public function __construct(array $options)
  {
    ...
    $url = isset($options["url"]) ? $options["url"] : 'https://api.stagingv3.microgen.id/query/api/v1';
